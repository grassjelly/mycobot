...
# mycobot.set_led_color("FF4500")
# time.sleep(3)

# mycobot.set_claw(CLOSE)
# time.sleep(3)

# mycobot.power_on()
# mycobot.set_claw(OPEN)

# print(mycobot.is_servo_enable(0))
print(mycobot.is_all_servo_enable())
print(mycobot.get_angles_of_radian())
# for i in range(255):
#     ret = mycobot.is_servo_enable(i)
#     if ret != -1:
#         print(i)

# import time, random, subprocess
# from mycobot.mycobot import MyCobot
# from mycobot.common import Angle, Coord
...
# python ~/esptool/esptool.py -b 1500000 --port /dev/ttyUSB0 write_flash --flash_freq 80m \
# 0x0000e000 boot_app0.bin \
# 0x00001000 bootloader_qio_80m.bin \
# 0x00010000 Atom2.1alpha.ino.bin \
# 0x00008000 Atom2.1alpha.ino.partitions.bin
